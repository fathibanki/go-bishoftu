          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className="text-center md:text-left">
                <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6 leading-tight text-center md:text-left">
                  Discover the Soul of Ethiopia/Bishoftu
                </h1>
                <p className="text-lg text-foreground/70 mb-8 leading-relaxed text-center md:text-left">
        ...
        <section className="min-h-screen flex items-center justify-center bg-background/50">
          <div className="max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg text-foreground/70 leading-relaxed">
              At Bishoftu Explorer, we connect travelers with the best hotels,
              resorts, and travel agencies in Bishoftu. Our mission is to make
              planning your trip easy, reliable, and unforgettable. Discover
              comfort, adventure, and authentic Ethiopian hospitality all in one
              platform.
            </p>
