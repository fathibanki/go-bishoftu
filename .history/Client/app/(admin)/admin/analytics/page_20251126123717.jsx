...
const trafficByCity = [
  { city: 'Bishoftu Lakeside', visits: 5200 },
  { city: 'Bishoftu Downtown', visits: 2800 },
  { city: 'Bishoftu Highlands', visits: 1900 },
]
    ...
    <section className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        {[
          ...
          { label: 'Emerging District', value: 'Bishoftu Highlands', metric: '+32% WoW' },
        ].map((card) => (
