...
const mockEvents = [
  { id: 'EVT-001', title: 'Lake Bishoftu Regatta', date: 'Mar 22, 2025', city: 'Bishoftu', status: 'Scheduled' },
  { id: 'EVT-002', title: 'Bishoftu Culinary Fair', date: 'Apr 5, 2025', city: 'Bishoftu', status: 'Draft' },
]
    ...
    <section className="space-y-8">
      <header className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          Coordinate signature Bishoftu experiences. Future city programs can piggyback on the same `/events` CRUD flows.
        </p>
      </header>
      ...
      <Card className="p-6 space-y-4">
        ...
        <form className="grid gap-4 md:grid-cols-2">
          <div className="space-y-2">
            ...
            <Input id="title" placeholder="Bishoftu Eco Retreat" />
          </div>
          <div className="space-y-2">
            <Label htmlFor="city">City Program</Label>
            <Input id="city" placeholder="Bishoftu" />
          </div>
          <div className="space-y-2">
